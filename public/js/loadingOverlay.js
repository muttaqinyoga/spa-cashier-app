...
(function () {
    if (typeof APP_LOADING !== "undefined") return;
    ...
    var lut = [];
    for (var il = 0; il < 256; il++) {
        lut[il] = (il < 16 ? "0" : "") + il.toString(16);
    }
    var uuid = function () {
    ...
    var lo = (function () {
        ...
        var param2hash = function (param) {
            return crc32(
                param["wrapClass"] + param["spinClass"] + param["spinID"]
            );
        };
    ...
    var invokeAPP_LOADING = function (config) {
        ...
        return lo.cache(param, function () {
            ...
            var cancelSpinner = function cancelSpinnerCallee(
                spinHandle,
                cancelledCallback,
                cancelUUID
            ) {
                ...
                cancelled_hash[spinHandle].cb_hash[cUUID] =
                    cancelled_cb_hash[cUUID];
                ...
                setTimeout(function () {
                    ...
                    if (spinTime < spinMin) {
                        ...
                        if (typeof cancelledCallback === "function") {
                            ...
                            cancelled_hash[spinHandle].cb_hash[
                                cUUID
                            ].invoked = true;
                            cancelled_cb_hash[cUUID].invoked = true;
                            cancelledCallback();
                            for (var c in cancelled_hash[spinHandle].cb_hash) {
                                if (
                                    !cancelled_hash[spinHandle].cb_hash[c]
                                        .invoked &&
                                    typeof cancelled_hash[spinHandle].cb_hash[c]
                                        .cb === "function"
                                ) {
                                    cancelled_hash[spinHandle].cb_hash[
                                        c
            ...
            var obj = {
                ...
                cancelAll: function () {
                    var spinWrapElem = document.querySelectorAll(
                        "#" + param["spinID"]
                    );
            ...
            appendHtmlToTarget(
                ...
                heredoc(function () {
                    ...
                    .replace(/%wrapClass%/g, param["wrapClass"])
                    .replace(/%spinClass%/g, param["spinClass"])
            );
    ...
    APP_LOADING = functionize(APP_LOADING, function (param) {
        return invokeAPP_LOADING(param);
    });
})();
